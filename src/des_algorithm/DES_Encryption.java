...
public class DES_Encryption {
	...
	public void getData()  throws Exception //this will get the plaintxt and key from file and convert them into binary form
	 {
	   input=new BufferedReader(new FileReader(new File("inputs\\plain_txt.txt")));
	   line=input.readLine();
	   String x[]=line.split(" ");
		...
		for(int i=0;i<x.length;i++)
		{
			   ...
			   for(int j=0;j<x[i].length();j++)
			    {
			       ...
			       String p=Integer.toBinaryString(search(x[i].charAt(j)));
			        if(p.equals("1"))
			         p="0000"+p;
			         ...
			         if(p.equals("1000") || p.equals("1001") || p.equals("1010") || p.equals("1011")|| p.equals("1100")|| p.equals("1101") || p.equals("1110")||p.equals("1111")) 
			         p="0"+p; 
		 ...
		 System.out.println("plain text in binary.....");
	 ...
	 public int search(char hn)
	 {
	     int i;
	     for(i=0;whatmsg[i]!=hn &&i<whatmsg.length;i++);
	     
	     return i;	
	 }//close of search()
	 
	 
	 public void padding_plaintxt()
	 {
	    
	 	int size=plaintext.length()%64;
	 	
	 	plaintxt=new int[plaintext.length()+(64-size)];
	 	...
	 	for(int i=0;i<plaintext.length();i++)
	      ...
	      System.out.println();
	      System.out.println("PADDING DONE......plaintxt is set");
	...
	public void permute_key() throws Exception
	 ...
	 public void putting_tempplain_txt(int n)
	 {
	   	for(int i=0;i<64;i++)
	   	 ...
	   	 System.out.println("Initial original plaintxt,...");
	   	 System.out.println(); 
	   	for(int i=1;i<65;i++)
	   	 {
	 ...
	 public void initial_permutation() throws Exception
	 {
	    ...
	    while(!line.equals("end"))
	 	...
	 	System.out.println("Initial permuted plain txt......"); 
	 	for(int i=1;i<65;i++)
	 	  {
	 ...
	 public void final_permutation() throws Exception
	  {
	   ...
	   {
	   	  BufferedWriter output=new BufferedWriter(new FileWriter("output_Cipher_text.txt",true));
